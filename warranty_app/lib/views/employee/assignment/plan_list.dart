...
class _PlanListState extends State<PlanList> {
  ...
  void initState() {
    super.initState();
    employeeActionsController.queryPlanOnStream(taskId: widget.taskId);
  }

  @override
  void dispose() {
    super.dispose();
    employeeActionsController.closePlanStream();
  }
            ...
            child: ListView.builder(
                scrollDirection:
                    MediaQuery.of(context).orientation == Orientation.portrait
                        ? Axis.vertical
                        : Axis.horizontal,
                itemCount: employeeActionsController.planList.length,
                itemBuilder: (BuildContext context, index) {
                  Item itemErr = Get.find<ProductController>().itemList[
                      employeeActionsController.planList[index].itemErrorId];
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                          "Status: ${employeeActionsController.planList[index].status.toString().split('.').last}",
